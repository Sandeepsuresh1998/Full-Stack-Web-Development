...
WHERE dvd_titles.genre_id = 9 AND dvd_titles.award IS NOT NULL
ORDER BY award ASC;
...
JOIN labels
	ON dvd_titles.label_id = labels.label_id
WHERE dvd_titles.genre_id = 19 AND dvd_titles.rating_id = 7 AND dvd_titles.release_date IS NOT NULL
